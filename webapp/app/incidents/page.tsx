  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative glass-card w-full max-w-lg p-6 space-y-5 z-10"
      >
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative glass-sidebar w-full max-w-md h-full flex flex-col z-10 border-l border-white/[0.08]"
      >
